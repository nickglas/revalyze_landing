...
const PaymentFailed = () => {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,theme(colors.destructive/0.1),transparent_50%)]" />
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-3">
                <p className="text-muted-foreground text-sm">
                  You can try again or return to our homepage to explore our
                  plans.
                </p>
