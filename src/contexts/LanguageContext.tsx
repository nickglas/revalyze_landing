...
const translations = {
  en: {
    ...
    'nav.contact': 'Contact',
    'nav.login': 'Login',
    'nav.viewPricing': 'View Pricing',
    
    // Hero section
    'hero.title': 'Transform Your Business with Data-Driven Insights',
    'hero.subtitle': 'Unlock the power of analytics to drive growth, optimize performance, and make informed decisions that propel your business forward.',
    ...
    'features.analytics.desc': 'Deep insights into your business performance with real-time data visualization and comprehensive reporting.',
    'features.dashboard.title': 'Intuitive Dashboard',
    'features.dashboard.desc': 'User-friendly interface that makes complex data simple to understand and act upon.',
    'features.integration.title': 'Seamless Integration',
    'features.integration.desc': 'Connect with your existing tools and platforms for a unified data experience.',
    ...
    'pricing.starter.desc': 'Perfect for small businesses getting started with data analytics',
    'pricing.pro.title': 'Pro Plan',
    'pricing.pro.price': '€149',
    'pricing.pro.period': '/month',
    'pricing.pro.desc': 'Advanced features for growing businesses that need deeper insights',
    'pricing.business.title': 'Business Plan',
    'pricing.business.price': '€499',
    'pricing.business.period': '/month',
    'pricing.business.desc': 'Enterprise-grade solution for large organizations',
    ...
    'about.content': 'We are passionate about helping businesses unlock the power of their data. Our team of experts has developed cutting-edge analytics solutions that transform raw data into actionable insights.',
  ...
  nl: {
    ...
    'hero.subtitle': 'Ontgrendel de kracht van analytics om groei te stimuleren, prestaties te optimaliseren en weloverwogen beslissingen te nemen die uw bedrijf vooruit helpen.',
    ...
    'features.subtitle': 'Alles wat u nodig heeft om uw bedrijf te analyseren, begrijpen en laten groeien',
    'features.analytics.title': 'Geavanceerde Analytics',
    'features.analytics.desc': 'Diepgaande inzichten in uw bedrijfsprestaties met real-time datavisualisatie en uitgebreide rapportage.',
    'features.dashboard.title': 'Intuïtief Dashboard',
    'features.dashboard.desc': 'Gebruiksvriendelijke interface die complexe data eenvoudig maakt om te begrijpen en er actie op te ondernemen.',
    'features.integration.title': 'Naadloze Integratie',
    'features.integration.desc': 'Verbind met uw bestaande tools en platforms voor een uniforme data-ervaring.',
    ...
    'pricing.starter.desc': 'Perfect voor kleine bedrijven die beginnen met data-analytics',
    'pricing.pro.title': 'Pro Plan',
    'pricing.pro.price': '€149',
    'pricing.pro.period': '/maand',
    'pricing.pro.desc': 'Geavanceerde functies voor groeiende bedrijven die diepere inzichten nodig hebben',
    'pricing.business.title': 'Business Plan',
    'pricing.business.price': '€499',
    'pricing.business.period': '/maand',
    'pricing.business.desc': 'Enterprise-grade oplossing voor grote organisaties',
    ...
    'about.content': 'Wij zijn gepassioneerd over het helpen van bedrijven om de kracht van hun data te ontgrendelen. Ons team van experts heeft geavanceerde analytics-oplossingen ontwikkeld die ruwe data transformeren in bruikbare inzichten.',
    ...
    'register.subtitle': 'Sluit u aan bij duizenden bedrijven die al Revalyze gebruiken',
